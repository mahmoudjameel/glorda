...
import { Search, MoreHorizontal, ShieldCheck, Ban } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";

const merchants = [
  { id: "MER-001", name: "متجر الأناقة", owner: "سارة أحمد", email: "sara@example.com", status: "active", date: "2024-01-15" },
  { id: "MER-002", name: "تك زون", owner: "خالد عمر", email: "khaled@example.com", status: "active", date: "2024-02-20" },
  { id: "MER-003", name: "بيتي الجميل", owner: "ليلى مصطفى", email: "laila@example.com", status: "pending", date: "2024-03-10" },
  { id: "MER-004", name: "عالم الرياضة", owner: "محمد علي", email: "mohamed@example.com", status: "suspended", date: "2024-01-05" },
  { id: "MER-005", name: "كتب وقهوة", owner: "نورة سعد", email: "nora@example.com", status: "active", date: "2024-04-01" },
];
